...
export const TokenCandidateSchema = z.object({
  ...
  source: z.enum(["jupiter", "dexscreener", "pumpfun", "lunacrush", "uniswap", "blockscout", "pons", "birdeye", "raydium"]).optional(),
...
export const LaunchProposalSchema = z.object({
  ...
  symbol: z.string(),
  name: z.string(),
  platform: z.enum(["pumpfun", "raydium", "pons", "uniswap"]),
  confidence: z.number().min(0).max(1),
  reasoning: z.string(),
  estimated_cost_eth: z.number(),
